...
先读：[上一版](v08_two_cta.html) · [下一版](v09_tuned.html)。本版重点：**两A共用一B，两个独立MMA warp**。下方保留完整逐行代码，先用图和具体例子建立整体过程，再对照行号。
...
![本版完整过程](v09_multi_consumer-process.svg)
...
![本版关键机制](v09_multi_consumer-mechanism.svg)
